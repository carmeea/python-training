...
amount_nok = int(amount_ron) / float(exchange_rates["exchange_rate_nok"])
print("Amount in Norvegian Kroner is:", round(amount_nok, 2))

amount_bgn = int(amount_ron) / float(exchange_rates["exchange_rate_bgn"])
print("Amount in Bulgarian Lev is:", round(amount_bgn, 2))

amount_hun = int(amount_ron) / float(exchange_rates["exchange_rate_hun"])
print("Amount in Hungarian Forint is:", round(amount_hun, 2))

amount_eur = int(amount_ron) / float(exchange_rates["exchange_rate_eur"])
print("Amount in Euro is:", round(amount_eur, 2))

amount_usd = int(amount_ron) / float(exchange_rates["exchange_rate_usd"])
