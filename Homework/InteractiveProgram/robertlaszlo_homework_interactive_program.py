...
amount_eur = float(amount_ron) / exchange_rate_eur
amount_lev = float(amount_ron) / exchange_rate_lev
amount_nok = float(amount_ron) / exchange_rate_nok
amount_forint = float(amount_ron) / exchange_rate_forint
amount_usd = float(amount_ron) / exchange_rate_usd
